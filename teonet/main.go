...
func main() {
	...
	flag.BoolVar(&param.ForbidHotkeysF, "forbid-hotkeys", false, "forbid hotkeys menu")
	...
	flag.BoolVar(&param.ShowClientsStatF, "show-clients", false, "show clients table")
